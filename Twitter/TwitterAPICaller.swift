...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    ...
    func postTweet(tweetString: String, success: @escaping () -> (), failure: @escaping
        (Error) -> ()) {
    ...
    func favortiteTweet(tweetId: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
    ...
    func unfavortiteTweet(tweetId: Int, success: @escaping () -> (), failure: @escaping (Error) -> ()) {
